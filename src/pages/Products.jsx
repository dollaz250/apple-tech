...
// IMAGES (FIXED with your real file names)
...
function Products() {
  ...
  return (
    <div className="min-h-screen text-white bg-gradient-to-br from-[#09111f] via-[#0f172a] to-[#050816]">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/5 border-b border-white/10">
        <div className="flex items-center justify-between px-10 py-5">
          ...
          <div className="space-x-6 text-sm text-gray-300">
            ...
            <a href="/#videos" className="hover:text-cyan-300">Videos</a>
          </div>
      ...
      {/* TITLE */}
      <h1 className="text-4xl font-bold text-center text-cyan-300 mb-12 mt-12">
          ...
          >
            ...
            <div className="p-5">
              ...
              <a
                ...
                target="_blank"
                className="inline-block mt-4 px-4 py-2 rounded-full bg-green-500/20 text-green-300 hover:bg-green-500/30 transition"
              >
                Order on WhatsApp
              </a>
